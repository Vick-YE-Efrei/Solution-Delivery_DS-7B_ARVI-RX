...
"""Streamlit demo for the chest-X-ray prototype.

This interface provides a simple human-friendly entry point for uploading an
image and inspecting the structured prediction output.
"""
